...
//            }
    ...
    public List<String> tabComplete(CommandSender sender, String alias, String[] args) {
        ...
        if (((args.length == 2) && "get".equalsIgnoreCase(args[0])) || "set".equalsIgnoreCase(args[0])) {
            return StringUtil.copyPartialMatches(args[1], MinecraftServer.cauldronConfig.getSettings().keySet(), new ArrayList<String>(MinecraftServer.cauldronConfig.getSettings().size()));
